                                 ...
                                 <thead>
                                   ...
                                   <tbody>
                                      ...
                                      <tr>
                                          ...
                                          <td>
                                          <div class="btn-group">
                                              <a href="#" class="btn btn-info btn-sm" data-toggle="modal" data-target="#editUser{{ $user->id }}"><i class="fa fa-edit">Edit</i></a>
                                               <a href="#" class="btn btn-sm btn-danger" data-toggle="modal" data-target="#deleteUser{{ $user->id }}"><i class="fa fa-trash">Del</i></a>
                                            </div>
                                        </td>
                                      </tr>
                                     {{-- modal for edit --}}
        ...
        <div class="modal-body">
            <form action="{{ route('users.update',$user->id)}}" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="password" name="password" readonly id="" value="{{ $user->password }}" class="form-control">
                </div>
               {{--  <div class="form-group">
